...
namespace tutorial
{
    internal class Program
    {
        ...
        {
            string notriesleft = "you have failed";

            string password = "7854"; //Apothikevoume password stin mnimi

            int tries = 3;//exw valei 3 prospa8eies

            Console.WriteLine("enter password you have " + tries + " tries");//Zitame to password apo ton xristi
